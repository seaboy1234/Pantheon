...
namespace Pantheon.Core
{
    internal class MessageDirector : IMessageDirector
    {
        ...
        public MessageDirector(INetworkManager networkManager)
        {
        ...
        private class MessageConsumer
        {
            ...
            public bool ShouldReceiveMessage(SystemMessage message)
            {
        ...
        public void QueueOnDisconnect(Message message)
        {
            ...
            msg.AddChannel(Channel.MessageDirector);
            msg.Write(MessageCode.MessageDirector_QueueOnDisconnect);
            message.WriteTo(msg);

            _outgoing.Add(new SystemMessage(msg, NetworkManager));
        }
